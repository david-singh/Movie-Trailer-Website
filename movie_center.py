...
iron_man = media.Movie(
    'Iron Man',
    'Genius, billionaire, and playboy Tony Stark fights villain Stane',
    'https://upload.wikimedia.org/wikipedia/en/thumb/7/70/Ironmanposter.JPG/220px-Ironmanposter.JPG',  # noqa
    'https://www.youtube.com/watch?v=8hYlB38asDY')

thor = media.Movie(
    'Thor',
    'Odin strips his son of his godly power and exiles him to Earth as mortal',
...
captain_america = media.Movie(
    'Captain America',
    'Steve Rogers is rejected for World War II military recruitment'
...
avengers = media.Movie(
    'The Avengers',
    'Superheros saves earth from Alien Invasion with the help of an'
    'organisation called S.H.I.E.L.D.',
...
avengers_second = media.Movie(
    'Avengers: Age of Ultron',
    'Tony Stark creates the Ultron Program to protect the world'
    'but program becomes hostile, The Avengers team up and fight',
...
captain_america_civil_war = media.Movie(
    ...
    'https://upload.wikimedia.org/wikipedia/en/thumb/5/53/Captain_America_Civil_War_poster.jpg/220px-Captain_America_Civil_War_poster.jpg',  # noqa
...
guardians_of_the_galaxy_2 = media.Movie(
    ...
    'https://upload.wikimedia.org/wikipedia/en/thumb/9/95/GotG_Vol2_poster.jpg/220px-GotG_Vol2_poster.jpg',  # noqa
    'https://www.youtube.com/watch?v=d96cjJhvlMA')
...
thor_second = media.Movie(
    'Thor: Ragnarok',
    'Imprisoned, the almighty Thor finds himself fighting Hulk,Thor must fight'
    'for survival and save his civilization from Hela',
    'https://upload.wikimedia.org/wikipedia/en/7/7d/Thor_Ragnarok_poster.jpg',  # noqa
    'https://www.youtube.com/watch?v=ue80QwXMRHg')

# creating List of various objects
movies_list = [iron_man, thor, captain_america, avengers, iron_man_3,
               guardians_of_the_galaxy, avengers_second,
               captain_america_civil_war, doctor_strange,
               guardians_of_the_galaxy_2, spider_man, thor_second]
